...
output1 = Dense(32,activation='relu')(dense4)

input2 = Input(shape=(25,))
dense_1 = Dense(128,activation='relu')(input2)
dense_2 = Dense(64,activation='relu')(dense_1)
dense_3 = Dense(128,activation='relu')(dense_2)
dense_4 = Dense(64,activation='relu')(dense_3)
output2 = Dense(32,activation='relu')(dense_4)
...
model.fit([x1_train, x2_train],[y1_train], epochs=150, batch_size=1,verbose=0,validation_split=1./9.)
