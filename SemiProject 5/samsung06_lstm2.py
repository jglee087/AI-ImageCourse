...
x_train_scaled = x_train_scaled.reshape(-1,25,5)
x_test_scaled = x_test_scaled.reshape(-1,25,5)

from keras.layers import Dense, LSTM
from keras.models import Sequential

model = Sequential()
model.add(LSTM(32,activation='tanh',input_shape=(25,5)))
...
model.fit(x_train_scaled, y_train, epochs= 80, batch_size=1,verbose=2,validation_split=0.2,callbacks=[early_stopping])
...
# pred_scaled=pred_scaled.reshape(-1,5,5)
